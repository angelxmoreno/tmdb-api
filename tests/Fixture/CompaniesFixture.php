...
class CompaniesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'logo_path' => ['type' => 'string', 'length' => 200, 'null' => true, 'default' => null, 'collate' => 'utf8mb4_unicode_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'origin_country' => ['type' => 'string', 'length' => 100, 'null' => true, 'default' => null, 'collate' => 'utf8mb4_unicode_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2020-11-10 22:49:43',
                'modified' => '2020-11-10 22:49:43',
            ],
        ];
        parent::init();
    }
